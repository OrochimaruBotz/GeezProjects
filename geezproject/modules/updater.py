"""
This module updates the geezproject based on upstream revision
"""
...
from geezproject import CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME
...
async def deploy(xx, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return repo.__del__()
        try:
            from geezproject.modules.sql_helper.globals import addgvar, delgvar
...
async def upstream(event):
    ...
    off_repo = b64decode(
        "aHR0cHM6Ly9naXRodWIuY29tL3Zja3lvdS9HZWV6UHJvamVjdHM="
    ).decode("utf-8")
    force_update = False
    try:
